...
async function japan(){
    const res = await fetch("https://newsapi.org/v2/top-headlines?country=jp&category=business&apiKey=d39fc87d08c949e2b6e9558423d988c1");
...
async function russia(){
    const res = await fetch("https://newsapi.org/v2/top-headlines?country=ru&category=sports&apiKey=d39fc87d08c949e2b6e9558423d988c1");
    const result = await res.json();
    data = result.articles;
    dataLength = data.length;
    author = data.author;
...
async function getData(){
    const res = await fetch("https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=d39fc87d08c949e2b6e9558423d988c1");
    const result = await res.json();
    data = result.articles;
    dataLength = data.length;
    author = data.author;
